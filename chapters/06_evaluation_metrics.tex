...
\begin{figure}[h!]
  \centering
  \subfigure[Cluster about tech and programing]{\includegraphics[scale=2]{./images/1clustertech.pdf}\label{clust:tech}}
  \hspace*{0.5cm}
  \centering
  \subfigure[Cluster about music]{\includegraphics[scale=2]{./images/2clustertech.pdf}\label{clust:music}}
  \label{fig:clusters}
