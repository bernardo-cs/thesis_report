...
There are many clustering algorithms~\cite{Hartigan:105051}. In the following section we will describe the particular case of the \ac{SOM} algorithm, the solution used in our work.
